...
<meta name="description" content="Ежемесячный журнал Patriki Times о Патриарших прудах: дизайн издания, модульная сетка, рубрикатор и заголовки, вёрстка номер за номером для печати и сайта.">
