...
# Сняты все листы до одного: лист 20 (нога робота входит в грязь) стоит на
# 46,9 с, лист 25 (маршрутка падает перед первой машиной) — на 66,2 с,
# момент падения занимает три кадра, поэтому секунда выбрана точно.
PAIRS = {
    ...
    18: 40.0, 19: 44.0, 20: 46.9, 21: 57.0, 22: 50.0, 23: 48.0, 24: 58.0,
    25: 66.2,
