#!/usr/bin/env python3
"""Заводит кейс «Обучающие видео для руководителей» Saint-Gobain
(/video/saintgobain/training) в Tilda-каталоги проектов. Идемпотентно.
...
/videoproduction). Планшетные дубли выведены из обращения
скриптом scripts/a2/sync_tablet_catalogs.py, в них не пишем.

Позиция: седьмая карточка в общих фидах и первая в витрине /videoproduction,
кейс свежий. Обложки рисует scripts/gen-sgtraining-covers.py."""
import json

URL = '/video/saintgobain/training'
UID = 999900558200
SORT = 1005100
POS = 6          # седьмая карточка в общих фидах
CAT_POS = 0      # первая в витрине /videoproduction
CIRCLE = '/images/lib/custom-sgtraining/cover-main.png'
SQUARE = '/images/lib/custom-sgtraining/cover-hover.png'
