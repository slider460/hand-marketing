#!/usr/bin/env python3
"""Добавляет кейс «Брошюра ТЦ „Смайл“» в Tilda-каталоги проектов (идемпотентно):
getproductslist.json, _950070406371 (главная), _689558768071 (/project)
и _573067849371 (категория Creative & Design, из неё собирается витрина
на /creativedesign).
...
Обложки mirror/images/lib/custom-smile-broch/ (круг-постер → фиолетовый квадрат)."""
import json

URL = '/creative/becar/smile'
UID = 999900557021
...
PRODUCT = {
    ...
    "priceold": "", "descr": "",
    "gallery": json.dumps([{"img": "/images/lib/custom-smile-broch/cover-main.png"},
                           {"img": "/images/lib/custom-smile-broch/cover-hover.png"}]),
    ...
    "editions": [{"uid": UID, "price": None, "priceold": "", "sku": "", "quantity": "",
                  "img": "/images/lib/custom-smile-broch/cover-main.png"}],
    "characteristics": [],
}
