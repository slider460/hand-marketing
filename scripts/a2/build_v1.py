...
function sweep(){var ls=document.querySelectorAll('link[href*="blackhole.invalid.com"]');for(var k=0;k<ls.length;k++)ls[k].href=fx(ls[k].getAttribute('href'));}var t=0,iv=setInterval(function(){sweep();if(++t>15)clearInterval(iv);},300);})();</script>'''
