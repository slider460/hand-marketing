...
с самих застроек (2011, 2012, 2013). Бренды-партнёры — по вывескам и POS-материалы
...
корпусом Marie Claire, разработали POS-материалы в точках продаж брендов-участников, вели семплинг
...
<dt>Состав работ</dt><dd>Застройка галерей, разработка и производство POS-материалов, промо-персонал
