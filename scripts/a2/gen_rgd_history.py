...
TITLE = ('Фильм к десятилетию ЦМ РЖД: 117 планов '
         '| Hand Marketing')
DESCR = ('Фильм на 3:54 к десятилетию терминально-складской дирекции ОАО «РЖД»: три съёмочные '
         'группы в Москве, Санкт-Петербурге и Калининграде, съёмка с воздуха.')
