...
<title>Продуктовые ролики OBO Bettermann: 10 фильмов | Hand Marketing</title>
<meta name="description" content="Кейс Hand Marketing: серия из 10 продуктовых видеороликов для OBO Bettermann. Съёмка в Академии OBO, ведущий Сергей Шаталов. Три направления: индустриальные инсталляции, инсталляции зданий, защита. Сценарий, студийная съёмка, макросъёмка, инфографика, монтаж.">
...
def intro():
    return (
      ...
      'предметная макросъёмка деталей и инфографика с выносками. Всё в фирменном '
...
def process():
    steps = [
        ...
        ('04', 'Инфографика', 'Выноски, обозначения и аннотации поверх кадра.'),
