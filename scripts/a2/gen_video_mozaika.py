...
DESCR = ('Презентационный ролик ТРЦ «Мозаика» на 4:31: съёмка с воздуха и в галереях, инфографика '
         'по цифрам объекта, 3D-карта подъездов и 13 синхронов с арендаторами.')
