...
<title>Брошюра «Дом с рыцарем» для Becar: 18 полос | Hand Marketing</title>
<meta name="description" content="Брошюра «Дом с рыцарем» для Becar Asset Management: 18 полос, чёрный лист и медная линия. Концепция, тексты и вёрстка издания, которое продаёт шесть апартаментов.">
