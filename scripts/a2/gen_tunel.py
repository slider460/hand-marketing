...
DESCR = ('Дезинфекционный тоннель AnVIT S12T для входа на мероприятие и защитные экраны: П-образные '
         'коллекторы, датчик движения, обработка за 3–5 секунд, экран из ПЭТ 4 мм.')
...
// «4 раза», но «16 раз»: русское склонение по последней цифре
function razа(n){var a=n%100,b=n%10;
  ...
  function setT(t){
    ...
    figE.innerHTML=(t>=4
      ...
      : 'Лист <b>'+String(t).replace('.',',')+' мм</b> провисает в <b>'+kk
        +'</b> '+razа(kk)+' сильнее выбранных четырёх'
