...
DESCR = ('Мультимедиа для выставочного стенда: LED-экраны и видеостены, проекция и naked eye 3D, '
         'сенсорные панели, интерактивные зоны и контент под ваши поверхности. От 150 000 ₽.')
...
KINDS = [
    ...
    ('Интерактивные зоны', 'Аттракцион, где гость участвует телом, а не кликом.'),
...
def hero():
    return (
        ...
        '<p class="mm-hero__lead">Экраны, проекции и интерактив, которые проектируются вместе '
...
def why():
    ...
    return (f'<section class="mm-sec"><div class="mm__in">'
            ...
            f'<a href="/exhibition/#ex-case">разборе стенда Самарской области</a>.</p>'
