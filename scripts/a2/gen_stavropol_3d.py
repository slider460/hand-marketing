...
<title>3D Mapping шоу в Ставрополе: 27 проекторов | Hand Marketing</title>
<meta name="description" content="3D mapping шоу на открытии новогодних мероприятий в Ставрополе, 13 декабря 2019: 27 проекторов, 410 000 люмен, дополненная реальность и более 25 000 зрителей.">
