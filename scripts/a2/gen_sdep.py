...
<title>Фирменный стиль SALESDEP для Becar | Hand Marketing</title>
<meta name="description" content="Айдентика SALESDEP для отдела продаж Becar Asset Management: логотип из двух блоков, паттерн из слова, палитра из 9 цветов и гайдлайн на 29 полос с макетами.">
