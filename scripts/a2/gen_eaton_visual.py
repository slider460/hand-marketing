...
<title>3D-визуализация оборудования Eaton | Hand Marketing</title>
<meta name="description" content="Кейс Hand Marketing для Eaton: центр обработки данных, коммерческий и промышленный объект в 3D. Размещение оборудования, 20 выносок, 10 позиций, плакаты 300 dpi.">
