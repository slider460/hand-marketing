...
def build():
    ...
    body=(f'{rc.header()}<main class="ct-main">{hero}{feats()}{works}<section class="ct-sec" id="ct-price"><h2 class="ct-seo__h ct-rev">Стоимость</h2>{cb.render("content")}</section>{ct_faq()}</main>'
