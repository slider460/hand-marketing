...
<title>Мультимедийный контент для выставок и мероприятий | Hand Marketing</title>
...
<meta property="og:type" content="website"><meta property="og:title" content="Мультимедийный контент для выставок и мероприятий | Hand Marketing">
...
def ct_faq():
    ...
    return (f'<section class="ct-sec" id="ct-seo">{css}'
            ...
            f'поэтому контент, <a href="/exhibition/multimedia/">мультимедиа для выставочного стенда</a>, интерактивные инсталляции '
            f'и сенсорные столы проектируются под конкретные экраны, залы и задачи, а не «в вакууме».</p>'
