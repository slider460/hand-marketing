...
.cn-hero__in{position:relative;z-index:2;padding-top:clamp(22px,3vw,32px);padding-bottom:clamp(52px,7vw,88px)}
...
def brief():
    return (
      ...
      '<p>Мы сняли по ролику на коллекцию: единый визуальный язык на всю линейку, '
