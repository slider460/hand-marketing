...
def compare():
    """Шторка «ТЗ и дизайн»: слева текст полос 8-9 без вёрстки, справа они же.

    Левую половину рисует scripts/ramada-assets.py и берёт РОВНО те строки, которые
    напечатаны на развороте, символ в символ. Поэтому шторка показывает честное
    «было/стало»: слово не поменялось ни одно, поменялась только вёрстка."""
    return (
      ...
      '<p class="rm-cmp__hint">Потяните ползунок: слева текст полос 8-9 как есть, '
      'справа он же после вёрстки.</p></div>'
      '<div class="rm-cmp__box rm-r" id="rm-cmp">'
      f'<img class="a" src="{IMG}/brief.jpg" width="1680" height="840" '
      'alt="Текст разворота без вёрстки: «Зарабатывай, не теряя», доход без личного '
      'участия инвестора, 100% собственность, прозрачная отчётность, выбор программы, '
      'ликвидность актива и сеть Vertical" loading="lazy">'
      f'<img class="b" src="{IMG}/spread-04.jpg" width="2500" height="1250" '
      'alt="Тот же текст в готовом развороте: круглый кадр с гостями, четыре акцента '
      'по дуге и неоновая вывеска сети Vertical на правой полосе" loading="lazy">'
      ...
      '</div>'
      '<p class="rm-cmp__cap rm-r">Слева ровно тот же текст, что напечатан справа: '
      'ни одного слова не добавлено и не убрано, сверено посимвольно. Разница только '
      'в вёрстке. Подряд это девять абзацев, которые надо дочитать до конца, чтобы '
      'понять, при чём тут сеть Vertical. В развороте заголовок держит круглый кадр '
      'с гостями, четыре аргумента расставлены по дуге и читаются по одному, '
      'а «Сеть Vertical» выходит на соседнюю полосу и становится доказательством, '
      'а не ещё одним абзацем.</p>'
      '</div></section>')
