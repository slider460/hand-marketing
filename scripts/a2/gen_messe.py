...
def hero():
    ...
    return (
      ...
      '<div class="lbl"><a href="/event" style="color:inherit;text-decoration:none">Event</a> · <a href="/event/novogodniy-korporativ/" style="color:inherit;text-decoration:none">Новогодний корпоратив</a> · Messe Düsseldorf Moscow</div>'
