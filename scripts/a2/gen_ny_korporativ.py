...
WORKS = [
    ...
    ('Техника', 'Звук, свет и проекция вместе с постоянными техническими партнёрами.'),
...
def works():
    ...
    return (f'<section class="ny-sec"><div class="ny__in">'
            ...
            f'наутро. Съёмку делаем своими операторами, проекцию, свет и звук ставим вместе '
            f'с постоянными техническими партнёрами.</p>'
