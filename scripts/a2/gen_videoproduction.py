...
WORK_TYPES=[
 ("Рекламные ролики",
  "Снимаем рекламу, которая продаёт продукт и работает на узнаваемость бренда. Для УАЗ Патриот это 60 секунд про блокировку дифференциала Eaton и три смены на бездорожье.",
 ...
 ("Корпоративные фильмы",
  ...
  [("ОАО «РЖД»","/images/vp/cadr_rgd.jpg","/media/transrzhd.mp4"),
   ("Power Technologies","/images/vp/cadr_power_tech.jpg","/media/pt-film-long.mp4")]),
 ("Репортажные ролики",
  ...
  [("Стенд Самарской области на ВДНХ","/images/vp/cadr_samara_vdnh.jpg","/media/samara-vdnh-report.mp4"),
   ("МФК «Саларис»","/images/vp/cadr_salaris.jpg","/media/salaris-event-fin180416.mp4"),
   ("ТРЦ «Ривьера»","/images/vp/cadr_riviera.jpg","/media/event-riviera.mp4")]),
 ("Вирусные ролики",
  "Придумываем ролики, которые пересылают друг другу сами. «Газель-трансформер» для ГАЗ и Eaton рекламирует не машину, а одну опцию в прайсе. Ролик 1:42, четыре смены, сториборд на 31 лист.",
...
CASES=[
 ("/video/saintgobain/training","Обучающие видео Saint-Gobain","/images/lib/custom-sgtraining/cover-main.png","/images/lib/custom-sgtraining/cover-hover.png"),
 ("/video/saintgobain/cx","Клиентский опыт Saint-Gobain","/images/lib/custom-sgcx/cover-main.png","/images/lib/custom-sgcx/cover-hover.png"),
...
<meta name="description" content="Видеопродакшн полного цикла: рекламные и корпоративные ролики, репортажи с мероприятий, обучающее видео. Сценарий, съёмка, монтаж и графика своей командой. Москва и вся Россия.">
...
VP_FAQ=[
 ('Что входит в видеопродакшн полного цикла?',
  'Всё от идеи до мастер-файла: сценарий и раскадровка, продюсирование, съёмочная группа и техника, локации и актёры, монтаж, цветокоррекция, графика и 3D, звуковое оформление. Отдаём мастер под каждую площадку: ТВ-эфир, экран мероприятия, сайт и вертикаль для соцсетей.'),
 ('Сколько стоит съёмка рекламного ролика?',
  'Зависит от хронометража, числа съёмочных дней, графики и прав на музыку. После брифа бесплатно готовим смету в двух вариантах, «оптимально» и «расширенно». Ролики для соцсетей и корпоративные фильмы считаем по той же схеме.'),
...
def seo_sec():
    ...
    steps=(('Бриф и сценарий','Цели, аудитория, референсы. Пишем сценарий, раскадровку и смету, согласовываем до съёмок.'),
           ...
           ('Съёмка','Съёмочная группа работает в студии, на объекте или на мероприятии, технику даёт постоянный партнёр.'),
...
def build():
    hero=(f'<section class="vp-hero">'
          ...
          f'<p class="vp-hero__lead">Снимаем рекламные ролики и корпоративные фильмы, репортажи с мероприятий и обучающее видео. Сценарий, съёмка, монтаж и графика внутри одной команды. Снимали для РЖД, Saint-Gobain, УАЗ, ГАЗ, Eaton и Power Technologies.</p>'
    ...
    works=(f'<section class="vp-sec" id="vp-works">'
           ...
           f'<p class="vp-sec__lead vp-rev">Нажмите на кадр, чтобы посмотреть ролик.</p>'
