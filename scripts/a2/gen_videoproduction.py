...
WORK_TYPES=[
 ...
 ("Репортажные ролики",
  "Видеосъёмка мероприятий, выставок и конференций своей съёмочной группой. Снимали стенд Самарской области на ВДНХ, презентацию МФК «Саларис» для арендаторов и вечер ТРЦ «Ривьера» прямо на стройке.",
...
def seo_sec():
    ...
    steps=(('Бриф и сценарий','Цели, аудитория, референсы. Пишем сценарий, раскадровку и смету, согласовываем до съёмок.'),
           ...
           ('Съёмка','Снимаем своей техникой и своими операторами: в студии, на объекте или на мероприятии.'),
