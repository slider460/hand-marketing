...
FAQ = [
    ...
    ('Сколько стоит организация мероприятия под ключ?',
     'Бюджет зависит от формата, площадки, числа гостей и техники. После брифа бесплатно готовим концепцию с предварительной сметой. Оставьте заявку, и мы перезвоним в течение рабочего дня.'),
...
<div class="ev-card"><i style="background:#673A7E"></i><h4>Корпоративные мероприятия</h4><p>Праздники, юбилеи и новогодние вечера. Новый год Samsung 2020 собрали из проекций с зимним лесом по дуге зала, Новый год Messe Düsseldorf провели прямо в офисе компании.</p></div>
