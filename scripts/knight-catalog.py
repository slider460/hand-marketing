#!/usr/bin/env python3
"""Добавляет кейс «Брошюра „Дом с рыцарем“» в Tilda-каталоги проектов
...
Обложки mirror/images/lib/custom-knight/ (круг-постер → медный квадрат)."""
import json

URL = '/creative/becar/knight-house'
UID = 999900557020
...
PRODUCT = {
    ...
    "priceold": "", "descr": "",
    "gallery": json.dumps([{"img": "/images/lib/custom-knight/cover-main.png"},
                           {"img": "/images/lib/custom-knight/cover-hover.png"}]),
    ...
    "editions": [{"uid": UID, "price": None, "priceold": "", "sku": "", "quantity": "",
                  "img": "/images/lib/custom-knight/cover-main.png"}],
    "characteristics": [],
}
