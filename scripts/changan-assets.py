...
MAPPING = [
    ...
    ('map-fire', 'DSC_6785.jpg', 'Кислотный контур по рёбрам кузова'),
    ('map-spark', 'DSC_6786.jpg', 'Разряды по борту'),
    ('map-flame', 'DSC_6787.jpg', 'Пламя по капоту и крылу'),
    ('map-wave', 'DSC_6789.jpg', 'Волны по борту'),
...
QUESTIONS = [
    ...
    'Кто разрабатывал коробку передач?',
    'Есть ли версия с полным приводом?',
    'Какая минимальная цена?',
    'Где собирают автомобиль?',
    'Цена у дилера отличается от прайс-листа',
    'Нет базовых комплектаций',
    'Сложности с запчастями',
    'Мало сервисных центров, далеко от больших городов',
]
LIKED = [
    'Цвета кузова, особенно коричневый',
    'Тёмно-красный из буклета спрашивали отдельно',
    'Цена',
    'Современный салон',
    'Дизайн кузова',
    'Качество сборки, мягкое закрывание дверей',
    'Классический четырёхступенчатый автомат',
    'Срок гарантии',
    'Дорожный просвет',
    'Шумоизоляция',
]
