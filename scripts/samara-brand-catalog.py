#!/usr/bin/env python3
"""Добавляет кейс «Фирменный стиль выставки „Самара“» в Tilda-каталоги проектов
...
Обложки mirror/images/lib/custom-samara-brand/ (круг-постер → синий квадрат)."""
import json
...
COVER = '/images/lib/custom-samara-brand/cover-main.png'
HOVER = '/images/lib/custom-samara-brand/cover-hover.png'

PRODUCT = {
    "uid": UID, "title": "⠀", "sku": "", "text": "Creative & Design", "mark": "",
    "quantity": "", "portion": 0, "unit": "", "single": "", "price": None,
    "priceold": "", "descr": "",
    "gallery": json.dumps([{"img": COVER}, {"img": HOVER}]),
